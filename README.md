...
```
curl -Ls "https://github.com/blobtoolkit/core/releases/download/0.3.4/blobtk-linux" > blobtk &&
chmod 755 blobtk
```
...
```
curl -Ls "https://github.com/blobtoolkit/core/releases/download/0.3.4/blobtk-macos" > blobtk &&
chmod 755 blobtk
```
